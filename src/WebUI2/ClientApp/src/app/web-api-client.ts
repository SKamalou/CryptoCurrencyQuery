...
export interface ICryptoCurrenciesClient {
    get(): Observable<CryptoCurrencyBriedDto[]>;
    getCurrentQuotes(symbol: string | null): Observable<CryptoCurrencyQuoteDto[]>;
}

@Injectable({
    providedIn: 'root'
})
export class CryptoCurrenciesClient implements ICryptoCurrenciesClient {
    ...
    get(): Observable<CryptoCurrencyBriedDto[]> {
        let url_ = this.baseUrl + "/api/CryptoCurrencies";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<CryptoCurrencyBriedDto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<CryptoCurrencyBriedDto[]>;
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<CryptoCurrencyBriedDto[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200!.push(CryptoCurrencyBriedDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
    ...
    getCurrentQuotes(symbol: string | null): Observable<CryptoCurrencyQuoteDto[]> {
        let url_ = this.baseUrl + "/api/CryptoCurrencies/{symbol}";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCurrentQuotes(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCurrentQuotes(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<CryptoCurrencyQuoteDto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<CryptoCurrencyQuoteDto[]>;
        }));
    }

    protected processGetCurrentQuotes(response: HttpResponseBase): Observable<CryptoCurrencyQuoteDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(CryptoCurrencyQuoteDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
...
export class CryptoCurrencyBriedDto implements ICryptoCurrencyBriedDto {
    symbol?: string | undefined;

    constructor(data?: ICryptoCurrencyBriedDto) {
        if (data) {
    ...
    static fromJS(data: any): CryptoCurrencyBriedDto {
        data = typeof data === 'object' ? data : {};
        let result = new CryptoCurrencyBriedDto();
        result.init(data);
        return result;
    }
...
export interface ICryptoCurrencyBriedDto {
    symbol?: string | undefined;
}

export class CryptoCurrencyQuoteDto implements ICryptoCurrencyQuoteDto {
    symbol?: string | undefined;
    price?: number;

    constructor(data?: ICryptoCurrencyQuoteDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CryptoCurrencyQuoteDto {
        data = typeof data === 'object' ? data : {};
        let result = new CryptoCurrencyQuoteDto();
        result.init(data);
        return result;
    }
...
export interface ICryptoCurrencyQuoteDto {
    symbol?: string | undefined;
    price?: number;
}
